...
namespace HtmlParser.Test
{
    ...
    {
        [Theory]
        [InlineData(@"Doctype: ""-//w3c//dtd xhtml 1.0 transitional//en"" ""http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd""""""", CompatibilityModeDoctype.Quirks)]
        ...
        [InlineData(@"Doctype: ""doctype""", CompatibilityModeDoctype.Quirks)]
