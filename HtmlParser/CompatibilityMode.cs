    ...
    public static class CompatibilityMode
    {
        ...
        private static readonly Regex RegexForQuirks =
            new Regex(
                ...
                @"|(-(//|/)(W3C|W3O)(//|/)DTD(\sW3)? HTML(\s((3 1995-03-24)|(3.2 Draft)|(3.2 Final)|(3.2)|(3.2S Draft)|(4.0 Frameset)|(4.0 Transitional)|(Experimental 19960712)|(Experimental 970421)|(3.0)|(Strict 3.0)))?(//|/)(en)?)" +
        ...
        public static CompatibilityModeDoctype GetCompatibilityModeFromDoctype(string doctype)
        {
            ...
            var items =
                doctype.Split(separator)
                    .Where(
                        x =>
                            !string.IsNullOrEmpty(x) && !string.IsNullOrWhiteSpace(x) && x != "-//" && x != " <html" &&
                            x != " /");
