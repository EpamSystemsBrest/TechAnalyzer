...
namespace HtmlParser
{
    ...
    public static class CompatibilityMode
    {
        ...
        private static readonly Regex RegexForLimit = new Regex(@"(-//W3C//DTD XHTML 1.0 (Frameset|Transitional)//(en)?)|(-//w3c//dtd html 4.01 (Transitional|Frameset)//$)",
            RegexOptions.IgnoreCase);
        ...
        private static readonly Regex RegexForQuirks =
            new Regex(
                ...
                @"(-(//|/)(W3C|W3O)(//|/)DTD(\sW3)? HTML\s((3 1995-03-24)|(3.2 Draft)|(3.2 Final)|(3.2)|(3.2S Draft)|(4.0 Frameset)|(4.0 Transitional)|(Experimental 19960712)|(Experimental 970421)|(3.0)|(Strict 3.0))//)"+
        ...
        public static CompatibilityModeDoctype GetCompatibilityModeFromDoctype(string doctype)
        {
            ...
            if (doctype.Equals("doctype html") || doctype.Equals(@"doctype html public """"")) return CompatibilityModeDoctype.NoQuirks;
            ...
            var items =
                doctype.Split(separator).Where(x => !string.IsNullOrEmpty(x) && !string.IsNullOrWhiteSpace(x)).ToArray();
            ...
            //if (RegexForQuirks.IsMatch(doctype) && Regex.IsMatch(doctype))
            //    return CompatibilityModeDoctype.Quirks;
